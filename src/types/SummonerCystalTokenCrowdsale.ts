...
export interface SummonerCystalTokenCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface SummonerCystalTokenCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SummonerCystalTokenCrowdsaleInterface;
